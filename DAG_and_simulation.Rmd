...
wealth: continous, measured as monthly income (rounded), it is quite low, let's take UB's average salary in the mean (although this isn't really right)
...
b_WLa <- 0 #direct wealth on land_own
...
b_LaIn <- 0 #bidirect land_own on intend_stay ?
